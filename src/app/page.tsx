  ...
  return (
    <main className="container mx-auto flex flex-col justify-center items-center">
      ...
      <div className="text-center">
        <h1 className="text-3xl pt-10 font-bold drop-shadow-lg">
          리그 오브 레전드 백과사전
        </h1>
        <p className="mt-4 ">
      ...
      <div className="mt-[40px] flex flex-col justify-center gap-10 w-1/2 pb-10">
        {/* 챔피언 목록 */}
        <div className="relative h-[500px] rounded-xl overflow-hidden group shadow-[0_35px_40px_-10px_rgba(0,0,0,0.7)]">
